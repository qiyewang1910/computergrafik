...
public class A03 {
    ...
    public static void main(String[] args){
        ...
        // 5.1 添加方向光源（如太阳光）
        Vec3 lichtRichtung = new Vec3(-0.5, 0.8, -0.3).normalize();  // 光源方向
